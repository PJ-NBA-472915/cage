...
class AgentFactory:
    ...
    def create_agent(
        self, name: str, config: Optional[AgentConfig] = None, **kwargs
    ) -> Optional[BaseAgent]:
        """
    ...
    def create_agent_with_config_override(
        self, name: str, config_overrides: dict[str, Any], **kwargs
    ) -> Optional[BaseAgent]:
        """
    ...
    def create_agents_by_type(
        self, agent_type: AgentType, count: int = 1, **kwargs
    ) -> list[BaseAgent]:
        """
    ...
    def create_agent_from_config(
        self, agent_class: type, config: AgentConfig, **kwargs
    ) -> BaseAgent:
        """
...
class CrewBuilder:
    ...
    def add_agents_by_type(
        self, agent_type: AgentType, count: int = 1
    ) -> "CrewBuilder":
        """
    ...
    def build(self) -> Crew:
        ...
        self.logger.info(
            f"Built crew with {len(self._agents)} agents and {len(self._tasks)} tasks"
        )
