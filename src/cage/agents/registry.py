...
from .base import BaseAgent, AgentType, AgentConfig
...
class AgentRegistry:
    ...
    def register_agent(
        ...
        self.logger.info(f"Registered agent '{agent_name}' of type {agent_class.__name__}")
    ...
    def get_agent_info(self, name: str) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "role": config.role,
            "goal": config.goal,
            "agent_type": agent_class(config, logger=self.logger)._get_agent_type().value,
